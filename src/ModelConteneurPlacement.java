...
public class ModelConteneurPlacement {
    ...
    public ConteneurGrille getGrille() {
        return grille;
    }

    public void setGrille(ConteneurGrille grille) {
        this.grille = grille;
    }

    public ConteneurPlacement getPanelPlacement() {
        return panelPlacement;
    }

    public void setPanelPlacement(ConteneurPlacement panelPlacement) {
